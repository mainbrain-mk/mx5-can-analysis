...
**Dieses Dokument ist das chronologische Logbuch zum CAN-Bus-Logging-Teilprojekt.**
Der aktuelle Stand steht in [`docs/status/can-bus.md`](../status/can-bus.md). Der
uebergeordnete Projektstand (Fahrleistungs-/Fahrdynamikmodell insgesamt -
Antriebsstrang, Teillast, Ausrollversuche, Vmax, IMU/Vibration etc.) steht in
[`docs/logs/projekt-stand.md`](projekt-stand.md).
